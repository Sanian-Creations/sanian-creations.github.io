...
const stop_transition = e => e.target.style.transition = "";
...
export function make_reorderable(container, move_handle_selector) {
    ...
    container.addEventListener("pointerdown", e => {
        ...
        if (el.classList.contains("moving")) return; // don't move the same element with two fingers...
...
/** @type { AbortController } */ abort_controller;
    ...
    init(container, elem, pointerId, hover_pos) {
        ...
        this.elem.dispatchEvent(new CustomEvent("reorder-pickup", { detail: this, bubbles: true }));
    }
    ...
    stop_moving() {
        ...
        this.elem.dispatchEvent(new CustomEvent("reorder-drop", { detail: this, bubbles: true }));
    }
